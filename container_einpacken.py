...
class PoseSubscriberClient(Node):
        ...
        try:
            for col in [1,2]:
                for idx in range(1,5):
                    if col == 1:
                        self.handle_column_1(idx, msg.x, msg.y, msg.z)
                    elif col== 2:
                        self.handle_column_2(idx, msg.x, msg.y, msg.z)
    ...
    def handle_column_1(self, idx, x, y, z):
        ...
        self.send_request(x, y, z, 3.14 , 0.04, 1.55, 50)

        y_goal = y - 46.0
        y_intermediate = y_goal +10
        #Move above glide punkt
        self.send_request(x, y_intermediate, z, 3.14 , 0.04, 1.55, 50)

        z_new = z - 90 #CHECK!!!
        #Move (down) glide punkt
        self.send_request(x, y_intermediate, z_new, 3.14 , 0.04, 1.55, 50)
        ...
        self.send_request(x_offset, y_intermediate, z_new, 3.14 , 0.04, 1.55, 50)

        #Move to goal position after glide in y axis
        self.send_request(x_offset, y_goal, z_new, 3.14 , 0.04, 1.55, 50)
    ...
    def handle_column_2(self, idx, x, y, z):
        ...
        self.move_pose_client.send_request(1.00, 0.99, 1.27, -2.93, -0.33, -2.57)
        ...
        self.send_request(x_offset, y_goal, z_goal, -2.96, 0.08, 0.23, 80) #vel 50
